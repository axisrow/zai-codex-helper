...
- Usage: Reference from command with `@/Users/axisrow/Projects/zai-codex-helper/.codex/gsd-core/workflows/{name}.md`
...
**gsd-core/**
- Purpose: Resources installed to /Users/axisrow/Projects/zai-codex-helper/.codex/
- Source: Copied by bin/install.js during installation
- Committed: Yes (source of truth)

**commands/**
- Purpose: Slash commands installed to /Users/axisrow/Projects/zai-codex-helper/.codex/commands/
- Source: Copied by bin/install.js during installation
- Committed: Yes (source of truth)
