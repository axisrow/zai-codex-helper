...
```
Agent(
  prompt="Read /Users/axisrow/Projects/zai-codex-helper/.codex/agents/gsd-security-auditor.md for instructions.\n\n" +
...
**State B (create):**
1. Read template from `/Users/axisrow/Projects/zai-codex-helper/.codex/gsd-core/templates/SECURITY.md`
