...
INSTALL_JS_GLOBAL="/Users/axisrow/Projects/zai-codex-helper/.codex/gsd-core/bin/install.js"
...
error: source skills root not found: <path>
       ...
       Run: node /Users/axisrow/Projects/zai-codex-helper/.codex/gsd-core/bin/install.js --global --<runtime>
```
Then exit.
