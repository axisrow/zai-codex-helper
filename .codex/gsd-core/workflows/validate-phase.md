...
```
Agent(
  prompt="Read /Users/axisrow/Projects/zai-codex-helper/.codex/agents/gsd-nyquist-auditor.md for instructions.\n\n" +
...
**State B (create):**
1. Read template from `/Users/axisrow/Projects/zai-codex-helper/.codex/gsd-core/templates/VALIDATION.md`
