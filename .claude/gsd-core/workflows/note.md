...
- **Global scope**: `/Users/axisrow/Projects/zai-codex-helper/.claude/notes/{YYYY-MM-DD}-{slug}.md` — fallback when no `.planning/`, or when `--global` flag is present
...
2. Ensure the notes directory exists (`.planning/notes/` or `/Users/axisrow/Projects/zai-codex-helper/.claude/notes/`)
...
2. Glob `/Users/axisrow/Projects/zai-codex-helper/.claude/notes/*.md` (if directory exists) — global notes
...
Global (/Users/axisrow/Projects/zai-codex-helper/.claude/notes/):
...
2. **No `.planning/`**: Falls back to global `/Users/axisrow/Projects/zai-codex-helper/.claude/notes/` — works in any directory
