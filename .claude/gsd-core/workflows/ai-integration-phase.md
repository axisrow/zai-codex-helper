...
<required_reading>
@/Users/axisrow/Projects/zai-codex-helper/.claude/gsd-core/references/ai-frameworks.md
@/Users/axisrow/Projects/zai-codex-helper/.claude/gsd-core/references/ai-evals.md
</required_reading>
...
```markdown
Read /Users/axisrow/Projects/zai-codex-helper/.claude/agents/gsd-framework-selector.md for instructions.
...
Copy template:
```bash
cp "/Users/axisrow/Projects/zai-codex-helper/.claude/gsd-core/templates/AI-SPEC.md" "${PHASE_DIR}/${PADDED_PHASE}-AI-SPEC.md"
```
...
```markdown
Read /Users/axisrow/Projects/zai-codex-helper/.claude/agents/gsd-ai-researcher.md for instructions.
...
```markdown
Read /Users/axisrow/Projects/zai-codex-helper/.claude/agents/gsd-domain-researcher.md for instructions.
...
```markdown
Read /Users/axisrow/Projects/zai-codex-helper/.claude/agents/gsd-eval-planner.md for instructions.
