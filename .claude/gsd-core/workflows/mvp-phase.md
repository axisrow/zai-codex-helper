...
<required_reading>
@/Users/axisrow/Projects/zai-codex-helper/.claude/gsd-core/references/user-story-template.md
@/Users/axisrow/Projects/zai-codex-helper/.claude/gsd-core/references/spidr-splitting.md
@/Users/axisrow/Projects/zai-codex-helper/.claude/gsd-core/references/planner-mvp-mode.md
</required_reading>
...
Normalize per `@/Users/axisrow/Projects/zai-codex-helper/.claude/gsd-core/references/phase-argument-parsing.md` (zero-pad integer phases to two digits).
...
Run three sequential `AskUserQuestion` calls. Each is free-text. After all three, assemble into the canonical sentence per `@/Users/axisrow/Projects/zai-codex-helper/.claude/gsd-core/references/user-story-template.md`:
...
Run the SPIDR rules from `@/Users/axisrow/Projects/zai-codex-helper/.claude/gsd-core/references/spidr-splitting.md`. Briefly:
