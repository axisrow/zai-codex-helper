...
ones). Reference: @/Users/axisrow/Projects/zai-codex-helper/.claude/gsd-core/references/edge-probe.md.
...
# — NOT the consuming project's git root — falling back to git toplevel / /Users/axisrow/Projects/zai-codex-helper/.claude.
...
EDGE_PROBE_JS=$(for _c in \
  ...
  "/Users/axisrow/Projects/zai-codex-helper/.claude/gsd-core/bin/lib/edge-probe.cjs" \
  "/Users/axisrow/Projects/zai-codex-helper/.claude/bin/lib/edge-probe.cjs"; do
  [ -f "$_c" ] && { echo "$_c"; break; }
done)
...
requirement list). Reference: @/Users/axisrow/Projects/zai-codex-helper/.claude/gsd-core/references/prohibition-probe.md — the
...
Use the SPEC.md template from @/Users/axisrow/Projects/zai-codex-helper/.claude/gsd-core/templates/spec.md.
