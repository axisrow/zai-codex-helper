...
Key references:
- @/Users/axisrow/Projects/zai-codex-helper/.claude/gsd-core/references/ui-brand.md (display patterns)
- @/Users/axisrow/Projects/zai-codex-helper/.claude/agents/gsd-user-profiler.md (profiler agent definition)
- @/Users/axisrow/Projects/zai-codex-helper/.claude/gsd-core/references/user-profiling.md (profiling reference doc)
</required_reading>
...
```bash
PROFILE_PATH="/Users/axisrow/Projects/zai-codex-helper/.claude/gsd-core/USER-PROFILE.md"
...
```bash
cp "/Users/axisrow/Projects/zai-codex-helper/.claude/gsd-core/USER-PROFILE.md" "/Users/axisrow/Projects/zai-codex-helper/.claude/USER-PROFILE.backup.md"
```
...
✓ Stores profile at /Users/axisrow/Projects/zai-codex-helper/.claude/gsd-core/USER-PROFILE.md
...
- The user-profiling reference doc at `/Users/axisrow/Projects/zai-codex-helper/.claude/gsd-core/references/user-profiling.md`
...
Reference: @/Users/axisrow/Projects/zai-codex-helper/.claude/gsd-core/references/user-profiling.md
...
Display: "✓ Profile written to /Users/axisrow/Projects/zai-codex-helper/.claude/gsd-core/USER-PROFILE.md"
...
- options (ALL pre-selected by default):
  ...
  - "Global CLAUDE.md" -- "Add profile to /Users/axisrow/Projects/zai-codex-helper/.claude/CLAUDE.md for all projects"

**If no artifacts selected:** Display "No artifacts generated. Your profile is saved at /Users/axisrow/Projects/zai-codex-helper/.claude/gsd-core/USER-PROFILE.md" and jump to step 10.
...
Display: "✓ Generated /gsd-dev-preferences at /Users/axisrow/Projects/zai-codex-helper/.claude/skills/gsd-dev-preferences/SKILL.md"
...
Display: "✓ Added profile section to /Users/axisrow/Projects/zai-codex-helper/.claude/CLAUDE.md"
...
```bash
BACKUP_PATH="/Users/axisrow/Projects/zai-codex-helper/.claude/USER-PROFILE.backup.md"
```
...
Your profile:    /Users/axisrow/Projects/zai-codex-helper/.claude/gsd-core/USER-PROFILE.md
```

Then list paths for each generated artifact:
```
Artifacts:
  ✓ /gsd-dev-preferences   /Users/axisrow/Projects/zai-codex-helper/.claude/skills/gsd-dev-preferences/SKILL.md
  ✓ CLAUDE.md section       <resolved claude_md_path, default ./.claude/CLAUDE.md>
  ✓ Global CLAUDE.md        /Users/axisrow/Projects/zai-codex-helper/.claude/CLAUDE.md
```
