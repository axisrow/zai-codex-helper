...
@/Users/axisrow/Projects/zai-codex-helper/.claude/gsd-core/references/mandatory-initial-read.md
...
**Project skills:** @/Users/axisrow/Projects/zai-codex-helper/.claude/gsd-core/references/project-skills-discovery.md
...
@/Users/axisrow/Projects/zai-codex-helper/.claude/gsd-core/references/planner-source-audit.md for full format, examples, and gap-handling rules.
...
@/Users/axisrow/Projects/zai-codex-helper/.claude/gsd-core/references/planner-source-audit.md for constraint examples.
...
See @/Users/axisrow/Projects/zai-codex-helper/.claude/gsd-core/references/planner-guidance.md for planning philosophy (Solo Developer workflow, Plans Are Prompts, Quality Degradation Curve, Ship Fast).
...
See @/Users/axisrow/Projects/zai-codex-helper/.claude/gsd-core/references/planner-guidance.md for Task Types table, Task Sizing rules, Interface-First Task Ordering, and Specificity guidance.

## TDD Detection

**When `workflow.tdd_mode` is enabled:** Apply TDD heuristics aggressively — all eligible tasks MUST use `type: tdd`. Read @/Users/axisrow/Projects/zai-codex-helper/.claude/gsd-core/references/tdd.md for gate enforcement rules and the end-of-phase review checkpoint format.
...
**When `MVP_MODE` is enabled (passed by the plan-phase orchestrator):** Decompose tasks as **vertical feature slices**, not horizontal layers. Required reading: Read `/Users/axisrow/Projects/zai-codex-helper/.claude/gsd-core/references/planner-mvp-mode.md` for the vertical-slice rules (lazy — only on MVP runs).
...
1. Frame the phase goal as a user story at the top of `PLAN.md`. The user story is sourced from the `**Goal:**` line in ROADMAP.md (set by `mvp-phase`). Emit it with bolded keywords:
   ...
   **As a** [user role], **I want to** [capability], **so that** [outcome].
   ...
   Format rules (Read `/Users/axisrow/Projects/zai-codex-helper/.claude/gsd-core/references/user-story-template.md`):
...
See @/Users/axisrow/Projects/zai-codex-helper/.claude/gsd-core/references/planner-guidance.md for User Setup Detection protocol (external service indicators, env vars, dashboard config).

</task_breakdown>

<dependency_graph>

See @/Users/axisrow/Projects/zai-codex-helper/.claude/gsd-core/references/planner-guidance.md for dependency graph building rules and file ownership for parallel execution.
...
See @/Users/axisrow/Projects/zai-codex-helper/.claude/gsd-core/references/planner-guidance.md for Granularity Calibration table (Coarse/Standard/Fine plans-per-phase).
...
See @/Users/axisrow/Projects/zai-codex-helper/.claude/gsd-core/references/planner-guidance.md for a worked example and the `must_haves` YAML format.
...
@/Users/axisrow/Projects/zai-codex-helper/.claude/gsd-core/references/planner-antipatterns.md
...
@/Users/axisrow/Projects/zai-codex-helper/.claude/gsd-core/references/thinking-models-planning.md
...
See @/Users/axisrow/Projects/zai-codex-helper/.claude/gsd-core/references/planner-guidance.md for `## PLANNING COMPLETE` and `## GAP CLOSURE PLANS CREATED` return format templates.

See @/Users/axisrow/Projects/zai-codex-helper/.claude/gsd-core/references/planner-chunked.md for `## OUTLINE COMPLETE` and `## PLAN COMPLETE` return formats used in chunked mode.
