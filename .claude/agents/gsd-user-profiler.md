...
<reference>
@/Users/axisrow/Projects/zai-codex-helper/.claude/gsd-core/references/user-profiling.md
...
Read the user-profiling reference document at `/Users/axisrow/Projects/zai-codex-helper/.claude/gsd-core/references/user-profiling.md` to load:
