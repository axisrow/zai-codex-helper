...
**Verification depth scales with `asvs_level`** (see @/Users/axisrow/Projects/zai-codex-helper/.claude/gsd-core/references/security-asvs-levels.md for full definitions):
