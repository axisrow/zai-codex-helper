...
<objective>
Manage the runtime skill surface without reinstall. Reads/writes `/Users/axisrow/Projects/zai-codex-helper/.claude/.gsd-surface.json`
(sibling to `/Users/axisrow/Projects/zai-codex-helper/.claude/.gsd-profile`) and re-stages the active skills directory in place.
Skill dirs live at `/Users/axisrow/Projects/zai-codex-helper/.claude/skills/gsd-*/`.
...
(`~/.claude`), NOT the skills sub-directory (`/Users/axisrow/Projects/zai-codex-helper/.claude/skills`).
...
`/Users/axisrow/Projects/zai-codex-helper/.claude/skills/gsd-*/` because the `claude global` layout has `destSubpath =
...
(i.e. `/Users/axisrow/Projects/zai-codex-helper/.claude/.gsd-surface.json`).
...
<execution_context>
Surface state file: `/Users/axisrow/Projects/zai-codex-helper/.claude/.gsd-surface.json`
Install profile marker: `/Users/axisrow/Projects/zai-codex-helper/.claude/.gsd-profile`
Skill dirs: `/Users/axisrow/Projects/zai-codex-helper/.claude/skills/gsd-*/`
Engine module: `/Users/axisrow/Projects/zai-codex-helper/.claude/gsd-core/bin/lib/surface.cjs`
Cluster definitions: `/Users/axisrow/Projects/zai-codex-helper/.claude/gsd-core/bin/lib/clusters.cjs`
</execution_context>
